...
--
-- Host: localhost    Database: B-Hak_Sengkea-db
-- ------------------------------------------------------
...
INSERT INTO `templates` VALUES (1,'classic','VERTICAL','Classic Blue','Orderzone University','#1d4ed8','#e0e7ff','Knowledge • Integrity • Service','#111827'),(2,'modern','HORIZONTAL','Modern Teal','Orderzone Corp','#0f766e','#ccfbf1','Building the future','#0f172a'),(3,'crimson','VERTICAL','Crimson Vertical','Orderzone Institute','#b91c1c','#fee2e2','Excellence in education','#1f2937'),(4,'slate','HORIZONTAL','Slate Horizontal','Orderzone Labs','#334155','#e2e8f0','Research & Innovation','#0f172a');
...
-- Dump completed on 2026-06-17 11:48:38
